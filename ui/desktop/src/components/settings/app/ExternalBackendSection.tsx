...
const i18n = defineMessages({
  ...
  description: {
    ...
    defaultMessage:
      'By default GooseMED starts a local backend. Use this to connect to an external ACP-compatible backend.',
  },
  useExternalServer: {
  ...
  serverUrlHelp: {
    ...
    defaultMessage:
      'Enter the HTTP(S) base URL. GooseMED checks /status and connects to /acp under this base.',
  },
  workingDir: {
  ...
  restartNote: {
    ...
    defaultMessage:
      'Changes apply to new chat windows. Restart GooseMED to update existing windows.',
  },
  urlProtocolError: {
